...
public class ListaDuplamente
{
    ...
    public boolean verificaIgualdade(ListaDuplamente l2) {
        return verificaIgualdade(prim, l2.prim);
    }
    /* Complexidade
    O(n) pois o método verifica cada elo somente com o elo correspondente
    na outra lista.
     */
