...
public class ListaCircular extends Lista
{
    ...
    /* Complexidade O(n)
       o método inverte lista terá complexidade maxima
       diretamente proporcional a quantidade de n(elementos) presentes
       na lista.
     */
    ...
    public ListaCircular inverteLista() {
        ...
        do {
            ...
            if (listaInvertida.vazia()) {
                listaInvertida.prim = q;
                q.prox = listaInvertida.prim;
            } else {
                Elo ult = listaInvertida.prim;
                while (ult.prox != listaInvertida.prim) {
                    ult = ult.prox;
                }
                q.prox = listaInvertida.prim;
                listaInvertida.prim = q;
                ult.prox = listaInvertida.prim;
            }
            p = p.prox;
        } while (p != prim);
