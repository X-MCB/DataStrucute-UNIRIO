...
public class ArvBinBusca<Chave extends Comparable<Chave>, Valor>
{
    ...
    public boolean eSimilar(ArvBinBusca<Chave, Chave> arvoreBin2){
        return eSimilarRecursivo(this.raiz, arvoreBin2.raiz);
    }

    private boolean eSimilarRecursivo(No no1, ArvBinBusca<Chave, Chave>.No no2){
        ...
        if(!no1.valor.equals(no2.valor)){
            return false;
        }

        boolean subArvoreEsquerda = eSimilarRecursivo(no1.esq, no2.esq);
        boolean subArvoreDireita = eSimilarRecursivo(no1.dir, no2.dir);
